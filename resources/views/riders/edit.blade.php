    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="mt-1 text-sm text-gray-600">Update rider information</p>
            </div>
            <a href="{{ route('riders.show', $rider) }}" class="text-sm text-gray-600 hover:text-gray-900 flex items-center">
                    ...
                    <div class="p-6">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="text" name="name" id="name" value="{{ old('name', $rider->first_name . ' ' . $rider->last_name) }}" required
                            ...
                            <div>
                                ...
                                <input type="text" name="nin" id="nin" value="{{ old('nin', $rider->national_id) }}" required
                            ...
                            <div>
                                ...
                                <input type="date" name="date_of_birth" id="date_of_birth" value="{{ old('date_of_birth', $rider->date_of_birth ? $rider->date_of_birth->format('Y-m-d') : '') }}" required
                            ...
                            <div>
                                ...
                                <input type="text" name="phone_number" id="phone_number" value="{{ old('phone_number', $rider->phone_number) }}" required
                            ...
                            <div class="md:col-span-2">
                                ...
                                <textarea name="address" id="address" rows="2" required
                                    ...
                                    class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition @error('address') border-red-500 @enderror">{{ old('address', $rider->address) }}</textarea>
                                @error('address')
                                    <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div>
                                ...
                                <select name="stage_id" id="stage_id" required
                                    ...
                                    @foreach(\App\Models\Stage::all() as $stage)
                                        <option value="{{ $stage->id }}" {{ old('stage_id', $rider->stage_id) == $stage->id ? 'selected' : '' }}>
                                            {{ $stage->name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div>
                                ...
                                <select name="status" id="status" required
                                    ...
                                    @foreach(['pending', 'active', 'suspended', 'inactive'] as $status)
                                        <option value="{{ $status }}" {{ old('status', $rider->status) == $status ? 'selected' : '' }}>
                                            {{ ucfirst($status) }}
                                        </option>
                                    @endforeach
                                </select>
                    ...
                    <div class="p-6">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="text" name="license_number" id="license_number" value="{{ old('license_number', $rider->license_number) }}" required
                            ...
                            <div>
                                ...
                                <select name="license_class" id="license_class" required
                                    ...
                                    <option value="A" {{ old('license_class', $rider->license_class) == 'A' ? 'selected' : '' }}>Class A (Motorcycle)</option>
                                    <option value="A1" {{ old('license_class', $rider->license_class) == 'A1' ? 'selected' : '' }}>Class A1 (Light Motorcycle)</option>
                                    <option value="B" {{ old('license_class', $rider->license_class) == 'B' ? 'selected' : '' }}>Class B (Car)</option>
                                </select>
                                @error('license_class')
                                    <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            ...
                            <div>
                                ...
                                <input type="date" name="license_issue_date" id="license_issue_date" value="{{ old('license_issue_date', $rider->license_issue_date ? $rider->license_issue_date->format('Y-m-d') : '') }}" required
                                    max="{{ date('Y-m-d') }}"
                            ...
                            <div>
                                ...
                                <input type="date" name="license_expiry_date" id="license_expiry_date" value="{{ old('license_expiry_date', $rider->license_expiry_date ? $rider->license_expiry_date->format('Y-m-d') : '') }}" required
                                    min="{{ date('Y-m-d') }}"
                    ...
                    <div class="p-6">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="text" name="emergency_contact_name" id="emergency_contact_name" value="{{ old('emergency_contact_name', $rider->emergency_contact_name) }}" required
                            ...
                            <div>
                                ...
                                <input type="text" name="emergency_contact_phone" id="emergency_contact_phone" value="{{ old('emergency_contact_phone', $rider->emergency_contact_phone) }}" required
                                    placeholder="e.g., 0700123456"
                            ...
                            <div>
                                ...
                                <select name="emergency_contact_relationship" id="emergency_contact_relationship" required
                                    ...
                                    <option value="Spouse" {{ old('emergency_contact_relationship', $rider->emergency_contact_relationship) == 'Spouse' ? 'selected' : '' }}>Spouse</option>
                                    <option value="Parent" {{ old('emergency_contact_relationship', $rider->emergency_contact_relationship) == 'Parent' ? 'selected' : '' }}>Parent</option>
                                    <option value="Sibling" {{ old('emergency_contact_relationship', $rider->emergency_contact_relationship) == 'Sibling' ? 'selected' : '' }}>Sibling</option>
                                    <option value="Child" {{ old('emergency_contact_relationship', $rider->emergency_contact_relationship) == 'Child' ? 'selected' : '' }}>Child</option>
                                    <option value="Friend" {{ old('emergency_contact_relationship', $rider->emergency_contact_relationship) == 'Friend' ? 'selected' : '' }}>Friend</option>
                                    <option value="Other" {{ old('emergency_contact_relationship', $rider->emergency_contact_relationship) == 'Other' ? 'selected' : '' }}>Other</option>
                                </select>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="text" name="motorcycle[plate_number]" id="motorcycle_plate_number" 
                                    value="{{ old('motorcycle.plate_number', $rider->motorcycle->registration_number ?? '') }}" required
                            ...
                            <div>
                                ...
                                <input type="text" name="motorcycle[make]" id="motorcycle_make" 
                                    value="{{ old('motorcycle.make', $rider->motorcycle->make ?? '') }}" required
                            ...
                            <div>
                                ...
                                <input type="text" name="motorcycle[model]" id="motorcycle_model" 
                                    value="{{ old('motorcycle.model', $rider->motorcycle->model ?? '') }}" required
                            ...
                            <div>
                                ...
                                <input type="number" name="motorcycle[year]" id="motorcycle_year" 
                                    value="{{ old('motorcycle.year', $rider->motorcycle->year ?? '') }}" required
                            ...
                            <div>
                                ...
                                <input type="text" name="motorcycle[color]" id="motorcycle_color" 
                                    value="{{ old('motorcycle.color', $rider->motorcycle->color ?? '') }}" required
                                    placeholder="e.g., Red"
                            ...
                            <div>
                                ...
                                <input type="text" name="motorcycle[engine_number]" id="motorcycle_engine_number" 
                                    value="{{ old('motorcycle.engine_number', $rider->motorcycle->engine_number ?? '') }}" required
                            ...
                            <div>
                                ...
                                <input type="text" name="motorcycle[chassis_number]" id="motorcycle_chassis_number" 
                                    value="{{ old('motorcycle.chassis_number', $rider->motorcycle->chassis_number ?? '') }}" required
